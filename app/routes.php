...
use App\Middleware\{Auth, Guest, Admin, Salesman, Mod_Mu};
...
return function (SlimApp $app) {
    ...
    $app->group('/user', function () {
        ...
        $this->get('/payment/purchase/vmqpay', App\Services\Payment::class . ':purchase');
        $this->post('/payment/purchase/vmqpay', App\Services\Payment::class . ':purchase');
    })->add(new Auth());
