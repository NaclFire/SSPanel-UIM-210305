...
{/function}
{function displaySSNode node=null}
    {$ssserver = $node['raw_node']->getSSItem($user)}
    <p>节点地址：<span class="card-tag tag-blue">{$ssserver['address']}</span></p>
    <p>节点端口：<span class="card-tag tag-volcano">{$ssserver['port']}</span></p>
    <p>节点加密：<span class="card-tag tag-purple">{$ssserver['method']}</span></p>
    <p>连接密码：<span class="card-tag tag-geekblue">{$ssserver['passwd']}</span></p>
{/function}
                                ...
                                <div class="nodemain">
                                    ...
                                    <div class="nodeinfo node-flex">
                                        ...
                                        <div class="nodetraffic node-flex">
                                            ...
                                            <span>{if $node['traffic_limit']>0}{$node['traffic_used']}/{$node['traffic_limit']}GB{else}{$node['traffic_used']}{/if}</span>
                                        </div>
                                        <!-- 节点流量倍率 -->
