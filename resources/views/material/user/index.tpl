                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade" id="info_center">
                                            ...
                                            {if URL::SSRCanConnect($user)}
                                                ...
                                                <hr/>
                                                <p>您好，您目前的 加密方式，混淆或协议 适用于 SSR 客户端，请您选用支持 SSR
                                                    的客户端来连接，或者到 <a href="/user/edit">资料编辑</a> 页面修改后再来查看此处。
                                                </p>
                                                <p>同时, ShadowsocksR
                                                    单端口多用户的连接不受您设置的影响，您可以在此使用相应的客户端进行连接</p>
                                            {elseif URL::SSCanConnect($user)}
                                                ...
                                                <hr/>
                                                <p>您好，您目前的 加密方式，混淆或协议 适用于 SS 客户端，请您选用支持 SS
                                                    协议的客户端来连接，或者到 <a href="/user/edit">资料编辑</a>
                                                    页面修改后再来查看此处。</p>
                                                <p>同时, Shadowsocks
                                                    单端口多用户的连接不受您设置的影响，您可以在此使用相应的客户端进行连接</p>
                                            {else}
                                        ...
                                        <div class="tab-pane fade active in" id="sub_center">
                                            ...
                                            {function name=printClient items=null}
                                                {foreach $items as $item}
                                                    <hr/>
                                                    <p>
                                                        <span class="icon icon-lg text-white">filter_9_plus</span> {$item['name']}
                                                        - [ {$item['support']} ]：</p>
                                                    <p>
                                                        应用下载：
                                                        {foreach $item['download_urls'] as $download_url}
                                                            {if !$download_url@first}.{/if}
                                                            <a class="btn-dl" href="{$download_url['url']}"><i
                                                                        class="material-icons icon-sm">cloud_download</i> {$download_url['name']}
                                                            </a>
                                                        {/foreach}
                                                    </p>
                                                    <p>
                                                        使用教程：
                                                        <a class="btn-dl"
                                                           href="{if $config['use_this_doc'] === false}/user/tutorial{else}{$item['tutorial_url']}{/if}"><i
                                                                    class="material-icons icon-sm">turned_in_not</i>
                                                            点击查看</a>
                                                    </p>
                                                    ...
                                                    <p>
                                                        ...
                                                        {foreach $item['subscribe_urls'] as $subscribe_url}
                                                            ...
                                                            {if $subscribe_url['type'] == 'href'}
                                                                <a class="btn-dl" href="{$url}"><i
                                                                            class="material-icons icon-sm">send</i> {$subscribe_url['name']}
                                                                </a>
                                                            {else}
                                            ...
                                            <div class="tab-pane fade active in" id="sub_center_general">
                                                ...
                                                <p><span class="icon icon-lg text-white">filter_1</span> [ V2Ray ]：
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['v2ray']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝订阅链接</a>
                                                    <a id="general_v2ray" class="copy-configcopy-config btn-dl"
                                                       onclick=Copyconfig("/user/getUserAllURL?type=v2ray","#general_v2ray","")><i
                                                                class="material-icons icon-sm">send</i> 拷贝全部节点 URL</a>
                                                </p>
                                                <hr/>
                                                ...
                                                <p><span class="icon icon-lg text-white">filter_2</span> [ Clash ]：
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['clash']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝订阅链接</a>
                                                </p>
                                            </div>
                                            <div class="tab-pane fade" id="sub_center_windows">
                                                <p><span class="icon icon-lg text-white">filter_1</span> SS - [ SS ]：
                                                </p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                    ...
                                                    .
                                                    <a class="btn-dl"
                                                       href="https://github.com/shadowsocks/shadowsocks-windows/releases"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Windows/Shadowsocks{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    <a id="win_ss" class="copy-config btn-dl"
                                                       onclick=Copyconfig("/user/getUserAllURL?type=ss","#win_ss","")><i
                                                                class="material-icons icon-sm">send</i> 拷贝全部节点 URL</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_2</span> SSR(R) - [
                                                    SS/SSR ]：</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                    ...
                                                    .
                                                    <a class="btn-dl"
                                                       href="https://github.com/shadowsocksrr/shadowsocksr-csharp/releases"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Windows/ShadowsocksR{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    <a class="copy-text btn-dl" data-clipboard-text="{$subInfo['ssr']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝订阅链接</a>
                                                    .
                                                    <a id="win_ssr" class="copy-config btn-dl"
                                                       onclick=Copyconfig("/user/getUserAllURL?type=ssr","#win_ssr","")><i
                                                                class="material-icons icon-sm">send</i> 拷贝全部节点 URL</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_3</span> SSTap - [
                                                    SS/SSR ]：</p>
                                                <p>
                                                    应用下载：
                                                ...
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Windows/SSTap{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                ...
                                                <p>
                                                    ...
                                                    <a class="btn-dl"
                                                       href="{if $config["subscribe_client"]===true}{if $config["subscribe_client_url"]==''}/user/getPcClient{else}{$config["subscribe_client_url"]}/getClient/{$getClient}{/if}?type=v2rayn-win{else}/ssr-download/v2rayn.zip{/if}"><i
                                                        ...
                                                        本站下载【高速】</a>
                                                    .
                                                    <a class="btn-dl" href="https://github.com/2dust/v2rayN/releases"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Windows/V2RayN{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['v2ray']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝订阅链接</a>
                                                    .
                                                    <a id="win_v2rayn" class="copy-config btn-dl"
                                                       onclick=Copyconfig("/user/getUserAllURL?type=v2ray","#win_v2rayn","")><i
                                                                class="material-icons icon-sm">send</i> 拷贝全部节点 URL</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_5</span> Clash for
                                                ...
                                                <p>
                                                    ...
                                                    .
                                                    <a class="btn-dl"
                                                       href="https://github.com/Fndroid/clash_for_windows_pkg/releases"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Windows/Clash-for-Windows{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    <a class="btn-dl" href="{$subInfo['clash']}"><i
                                                                class="material-icons icon-sm">send</i> 配置文件下载</a>
                                                    .
                                                    <a class="btn-dl"
                                                       href="clash://install-config?url={urlencode($subInfo['clash'])}"><i
                                                                class="material-icons icon-sm">send</i> 配置一键导入</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_6</span> ClashR for
                                                    Windows - [ SS/SSR/VMess ]：</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl" href="#"><i class="material-icons icon-sm">cloud_download</i>
                                                        暂无下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                ...
                                                <p>
                                                    使用方式：
                                                    <a class="btn-dl" href="{$subInfo['clashr']}"><i
                                                                class="material-icons icon-sm">send</i> 配置文件下载</a>
                                                    .
                                                    <a class="btn-dl"
                                                       href="clash://install-config?url={urlencode($subInfo['clashr'])}"><i
                                                                class="material-icons icon-sm">send</i> 配置一键导入</a>
                                                </p>
                                            ...
                                            <div class="tab-pane fade" id="sub_center_mac">
                                                <p><span class="icon icon-lg text-white">filter_1</span> Surge - [
                                                    SS/VMess ]：</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                       href="https://nssurge.com/mac/v3/Surge-latest.zip"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/macOS/Surge{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['surge4']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝 4.x 托管链接</a>
                                                    .
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['surge3']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝 3.x 托管链接</a>
                                                    .
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['surge_node']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝 3.x 节点链接</a>
                                                    .
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['surge2']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝 2.x 托管链接</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_2</span> ClashX - [
                                                    SS/VMess ]：</p>
                                                <p>
                                                    应用下载：
                                                    ...
                                                    .
                                                    <a class="btn-dl"
                                                       href="https://github.com/yichengchen/clashX/releases"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/macOS/ClashX{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                ...
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_3</span> ClashXR - [
                                                    SS/SSR/VMess ]：</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl" href="#"><i class="material-icons icon-sm">cloud_download</i>
                                                ...
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_4</span> V2RayU - [
                                                    SS/VMess ]：</p>
                                                <p>
                                                    应用下载：
                                                ...
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/macOS/V2RayU{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                ...
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_5</span> ShadowsocksX-NG
                                                    - [ SS ]：</p>
                                                <p>
                                                    应用下载：
                                                ...
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/macOS/ShadowsocksX-NG{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    <a id="mac_ss" class="copy-config btn-dl"
                                                       onclick=Copyconfig("/user/getUserAllURL?type=ss","#mac_ss","")><i
                                                                class="material-icons icon-sm">send</i> 拷贝全部节点 URL</a>
                                                </p>
                                                <hr/>
                                                ...
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/macOS/ShadowsocksX-NG-R8{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                            ...
                                            <div class="tab-pane fade" id="sub_center_ios">
                                                ...
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                       href="https://itunes.apple.com/us/app/surge-3/id1442620678?ls=1&mt=8"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/iOS/Surge{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    相关说明：
                                                    Surge 4 托管配置中可能含有 VMess 节点，如您未订阅 Surge 4 请使用 3.x
                                                    一键.
                                                ...
                                                <p>
                                                    使用方式：
                                                    <a class="btn-dl"
                                                       href="surge3:///install-config?url={urlencode($subInfo['surge4'])}"><i
                                                                class="material-icons icon-sm">send</i> 4.x 一键</a>
                                                    .
                                                    <a class="btn-dl"
                                                       href="surge3:///install-config?url={urlencode($subInfo['surge3'])}"><i
                                                                class="material-icons icon-sm">send</i> 3.x 一键</a>
                                                    .
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['surge_node']}"><i
                                                                class="material-icons icon-sm">send</i> 节点 List</a>
                                                    .
                                                    <a class="btn-dl"
                                                       href="surge:///install-config?url={urlencode($subInfo['surge2'])}"><i
                                                                class="material-icons icon-sm">send</i> 2.x 一键</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_2</span> Kitsunebi - [
                                                    SS/VMess ]：</p>
                                                <p>该客户端专属订阅链接支持同时订阅 SS/V2Ray 节点.</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                       href="https://itunes.apple.com/us/app/kitsunebi-proxy-utility/id1446584073?ls=1&mt=8"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/iOS/Kitsunebi{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['ss']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝 SS 订阅链接</a>
                                                    .
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['kitsunebi']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝该应用专属订阅链接</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_3</span> Quantumult - [
                                                    SS/SSR/VMess ]：</p>
                                                <p>完整策略组配置 为使用了策略组结构的配置文件.</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                       href="https://itunes.apple.com/us/app/quantumult/id1252015438?ls=1&mt=8"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/iOS/Quantumult_sub{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    ...
                                                    .
                                                    <a class="copy-text btn-dl" data-clipboard-text="{$subInfo['ssr']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝 SSR 订阅链接</a>
                                                    .
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['quantumult_v2']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝 V2Ray 订阅链接</a>
                                                    <!--
                                                        .
                                                        ...
                                                        -->
                                                    .
                                                    <a id="quan_conf" class="copy-config btn-dl"
                                                       onclick=Copyconfig("{$subInfo['quantumult_conf']}","#quan_conf","quantumult://settings?configuration=clipboard")><i
                                                                class="material-icons icon-sm">send</i>
                                                        完整策略组配置</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_4</span> QuantumultX - [
                                                    SS/SSR/VMess ]：</p>
                                                <p>该客户端专属订阅链接支持同时订阅 SS/SSR/V2Ray 节点.</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                       href="https://apps.apple.com/us/app/quantumult-x/id1443988620"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/iOS/QuantumultX{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    ...
                                                    .
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['quantumultx']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝该应用专属订阅链接</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_5</span> Shadowrocket -
                                                    [ SS/SSR/VMess/Trojan ]：</p>
                                                <p>该客户端专属订阅链接支持同时订阅 SS/SSR/V2Ray 节点.</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                       href="https://itunes.apple.com/us/app/shadowrocket/id932747118?mt=8"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/iOS/Shadowrocket{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    ...
                                                    .
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['trojan']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝 Trojan 订阅链接</a>
                                                    .
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['shadowrocket']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝该应用专属订阅链接</a>
                                                    .
                                                    <a class="btn-dl"
                                                       onclick=AddSub("{$subInfo['shadowrocket']}","shadowrocket://add/sub://")><i
                                                                class="material-icons icon-sm">send</i> 一键导入
                                                        Shadowrocket</a>
                                                </p>
                                            ...
                                            <div class="tab-pane fade" id="sub_center_android">
                                                ...
                                                <p>
                                                    ...
                                                    .
                                                    <a class="btn-dl"
                                                       href="https://github.com/shadowsocks/shadowsocks-android/releases"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    插件下载：
                                                ...
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Android/Shadowsocks-Android{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    <a class="copy-text btn-dl" data-clipboard-text="{$subInfo['ssa']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝该应用专属订阅链接</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_2</span> SSR(R) - [ SSR
                                                    ]：</p>
                                                <p>
                                                    应用下载：
                                                ...
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Android/ShadowsocksR{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                ...
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_3</span> V2RayNG - [
                                                    SS/VMess ]：</p>
                                                <p>
                                                    应用下载：
                                                    ...
                                                    .
                                                    <a class="btn-dl"
                                                       href="https://github.com/2dust/v2rayNG/releases"><i
                                                                class="material-icons icon-sm">cloud_download</i> 官方下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Android/V2RayNG{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                ...
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_4</span> Surfboard - [
                                                    SS/VMess ]：</p>
                                                <p>该客户端新版本支持 V2Ray
                                                    节点，如您遇到配置解析错误等情况，请尝试升级客户端.</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                       href="https://play.google.com/store/apps/details?id=com.getsurfboard"><i
                                                                class="material-icons icon-sm">cloud_download</i> Google
                                                        Play 下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Android/Surfboard{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['surfboard']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝托管链接</a>
                                                    .
                                                    <a class="btn-dl" href="{$subInfo['surfboard']}"><i
                                                                class="material-icons icon-sm">send</i> 配置文件下载</a>
                                                </p>
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_5</span> Kitsunebi - [
                                                    SS/VMess ]：</p>
                                                <p>该客户端专属订阅链接支持同时订阅 SS 和 V2Ray 节点.</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                       href="https://play.google.com/store/apps/details?id=fun.kitsunebi.kitsunebi4android"><i
                                                                class="material-icons icon-sm">cloud_download</i> Google
                                                        Play 下载</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Android/Kitsunebi{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                                ...
                                                <hr/>
                                                <p><span class="icon icon-lg text-white">filter_6</span> Clash for
                                                    Android - [ SS/VMess ]：</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                       href="https://play.google.com/store/apps/details?id=com.github.kr328.clash"><i
                                                                class="material-icons icon-sm">cloud_download</i> Google
                                                        Play 下载</a>
                                                </p>
                                                <p>
                                                    ...
                                                    <a class="copy-text btn-dl"
                                                       data-clipboard-text="{$subInfo['clash']}"><i
                                                                class="material-icons icon-sm">send</i> 拷贝 Clash 订阅链接</a>
                                                    .
                                                    <a class="btn-dl"
                                                       href="clash://install-config?url={urlencode($subInfo['clash'])}"><i
                                                                class="material-icons icon-sm">send</i> 配置一键导入</a>
                                            ...
                                            <div class="tab-pane fade" id="sub_center_linux">
                                                <p><span class="icon icon-lg text-white">filter_1</span> Electron SSR -
                                                    [ SSR ]：</p>
                                                <p>
                                                    应用下载：
                                                ...
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Linux/ElectronSSR{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
                                            ...
                                            <div class="tab-pane fade" id="sub_center_router">
                                                <p><span class="icon icon-lg text-white">filter_1</span> Koolshare
                                                    固件路由器/软路由：</p>
                                                <p>
                                                    应用下载：
                                                    <a class="btn-dl"
                                                       href="https://github.com/hq450/fancyss_history_package"><i
                                                                class="material-icons icon-sm">cloud_download</i>
                                                        FancySS 下载页面</a>
                                                    .
                                                    <a class="btn-dl"
                                                       href="https://github.com/hq450/fancyss_history_package/tree/master/fancyss_X64"><i
                                                                class="material-icons icon-sm">cloud_download</i>
                                                        FancySS 历史下载页面下载 V2Ray 插件</a>
                                                </p>
                                                <p>
                                                    使用教程：
                                                    <a class="btn-dl"
                                                       href="{if $config['use_this_doc'] === false}/user/tutorial{else}/doc/#/Router/Koolshare{/if}"><i
                                                                class="material-icons icon-sm">turned_in_not</i> 点击查看</a>
                                                </p>
                                                <p>
                                                    使用方式：
