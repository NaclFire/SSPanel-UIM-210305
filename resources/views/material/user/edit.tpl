                    ...
                    <div class="card-main" hidden="hidden">
                        <div class="card-inner">
                            <div class="card-inner">
                                ...
                                <button class="btn btn-subscription" type="button" id="filter-btn-universal">通用
                                </button>
                            </div>
                            <div class="card-inner">
                                <div class="cardbtn-edit">
                                ...
                                <p>
                                    当前加密方式：<code id="ajax-user-method"
                                                       data-default="method">[{if URL::CanMethodConnect($user->method) == 2}SS{else}SS/SSR{/if}
                            ...
                            <div class="card-inner">
                                ...
                                <p>当前协议：<code id="ajax-user-protocol"
                                                  data-default="protocol">[{if URL::CanProtocolConnect($user->protocol) == 3}SS/SSR{else}SSR{/if}
                            ...
                            <div class="card-inner">
                                <p>当前混淆方式：<code id="ajax-user-obfs"
                                                      data-default="obfs">[{if URL::CanObfsConnect($user->obfs) >= 3}SS/SSR{elseif URL::CanObfsConnect($user->obfs) == 1}SSR{else}SS{/if}
                                        可连接] {$user->obfs}</code></p>
                                <p>SS 和 SSR 支持的混淆类型有所不同，simple_obfs_* 为 SS 的混淆方式，其他为 SSR
                                    的混淆方式</p>
                                <div class="form-group form-group-label control-highlight-custom dropdown">
                            ...
                            <div class="card-inner">
                                <div class="cardbtn-edit">
                                    ...
                                    <div class="reset-flex">
                                        <a class="reset-link btn btn-brand-accent btn-flat"><i
                                                    class="icon">autorenew</i>&nbsp;</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-inner">
                                        ...
                                        <div class="form-group form-group-label">
                                            <label class="floating-label"
                                                   for="port-specify">在这输入想钦定的端口号</label>
                        ...
                        <div class="card-inner">
                            <div class="card-inner">
                                <div class="cardbtn-edit">
                                    ...
                                    <div><a class="btn btn-flat btn-brand-accent" href="/user/telegram_reset"><span
                                                    class="icon">not_interested</span>&nbsp;</a></div>
                                </div>
                                <div class="text-center">
                                    <p>当前绑定的 Telegram 账户：<a
                                                href="https://t.me/{$user->im_value}">@{$user->im_value}</a></p>
                                </div>
                                {else}
                            </div>
                            ...
                            {if $config['use_new_telegram_bot'] === true}
                                <p>
                                    <button class="copy-text btn btn-subscription" type="button"
                                            data-clipboard-text="{$bind_token}">点击拷贝绑定码
                                    </button>
                                    私聊发给 Telegram 机器人 <a href="https://t.me/{$telegram_bot}">@{$telegram_bot}</a>
                                    以绑定 Telegram
                                </p>
                                <p><a class="btn btn-subscription" type="button"
                                      href="https://t.me/{$telegram_bot}?start={$bind_token}">一键绑定至账户</a>
                                    手机电脑平板等如已安装 Telegram 可点击</p>
                            {else}
                                <p>截图保存下方的二维码图片，切勿拍照保存否则会导致解码失败</p>
                                <p>私聊发给 Telegram 机器人 <a href="https://t.me/{$telegram_bot}">@{$telegram_bot}</a>
                                    以绑定 Telegram</p>
                                <div class="form-group form-group-label">
                                    <div class="text-center">
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        if (data.ret) {
                            ...
                            $("#result").modal();
                            $$.getElementById('msg').innerHTML = '修改失败：' + data.msg;
                        }
                    },
                    error: (jqXHR) => {
                        $("#result").modal();
