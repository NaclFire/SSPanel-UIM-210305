            ...
            <div class="auth-main auth-row">
                    ...
                    <div class="rowtocol">
                        <div class="auth-row">
                            <div class="form-group-label auth-row">
                                ...
                                <input class="form-control maxwidth-auth" id="email" type="email" maxlength="32"
                ...
                <div class="auth-bottom auth-row auth-reg">
                    <div class="tgauth">
                        ...
                        <p>注册即代表同意<a href="/tos">服务条款</a>，以及保证所录入信息的真实性，如有不实信息会导致账号被删除。
                        </p>
