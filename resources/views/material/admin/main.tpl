                ...
                <li>
                    {if $user->isAdmin()}
                        ...
                        <ul class="menu-collapse collapse in" id="ui_menu_me">
                            ...
                            <li><a href="/admin/ticket"><i class="icon icon-lg">question_answer</i>&nbsp;工单管理</a>
                            </li>
                    ...
                    <ul class="menu-collapse collapse in" id="ui_menu_user">
                        ...
                        {if $user->isAdmin()}
                            ...
                            <li><a href="/admin/alive"><i class="icon icon-lg">important_devices</i>&nbsp;在线IP</a>
                            </li>
                        {/if}
                    </ul>
                    {if $user->isAdmin()}
                        ...
                        <ul class="menu-collapse collapse in" id="ui_menu_config">
                            <li><a href="/admin/config/telegram"><i class="icon icon-lg">supervisor_account</i>&nbsp;Telegram</a>
                            </li>
                            <li><a href="/admin/config/register"><i class="icon icon-lg">supervisor_account</i>&nbsp;用户注册</a>
                            </li>
                        </ul>
                        <a class="waves-attach" data-toggle="collapse" href="#ui_menu_detect">审计</a>
                        <ul class="menu-collapse collapse in" id="ui_menu_detect">
                            <li><a href="/admin/detect"><i class="icon icon-lg">account_balance</i>&nbsp;审计规则</a>
                            </li>
                            <li><a href="/admin/detect/log"><i
                                            class="icon icon-lg">assignment_late</i>&nbsp;审计记录</a>
                            </li>
                            <li><a href="/admin/detect/ban"><i class="icon icon-lg">text_fields</i>&nbsp;审计封禁</a>
                            </li>
                        </ul>
                    {/if}
                    ...
                    <ul class="menu-collapse collapse in" id="ui_menu_trade">
                        ...
                        {if $config['payment_system']=='chenAlipay'}
                            <li><a href="/admin/editConfig"><i class="icon icon-lg">shopping_cart</i>&nbsp;支付设置</a>
                            </li>
                        {/if}
                    </ul>
